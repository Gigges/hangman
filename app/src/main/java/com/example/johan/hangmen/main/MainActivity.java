...
public class MainActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!user_name.isEmpty()){
            ...
            Intent chatActivity=new Intent(MainActivity.this, com.example.johan.hangmen.main.ConnectBtActivity.class);
        ...
        if (resultCode != ConnectionResult.SUCCESS) {
            if (GooglePlayServicesUtil.isUserRecoverableError(resultCode)) {
                GooglePlayServicesUtil.getErrorDialog(resultCode, this,
                        com.example.johan.hangmen.main.Util.PLAY_SERVICES_RESOLUTION_REQUEST).show();
            } else {
    ...
    private String getRegistrationId(Context context) {
        ...
        String registrationId = prefs.getString(com.example.johan.hangmen.main.Util.PROPERTY_REG_ID, "");
        ...
        // the new app version.
        int registeredVersion = prefs.getInt(com.example.johan.hangmen.main.Util.PROPERTY_APP_VERSION, Integer.MIN_VALUE);
    ...
    private String getUserName(Context context) {
        final SharedPreferences prefs = getGCMPreferences(context);
        String User_name = prefs.getString(com.example.johan.hangmen.main.Util.USER_NAME, "");
        ...
        new AsyncTask() {
            ...
            protected String doInBackground(Object[] params) {
                ...
                try {
                    ...
                    regid = gcm.register(com.example.johan.hangmen.main.Util.SENDER_ID);
    ...
    private void storeRegistrationId(Context context, String regId) {
        ...
        editor.putString(com.example.johan.hangmen.main.Util.PROPERTY_REG_ID, regId);
        editor.putInt(com.example.johan.hangmen.main.Util.PROPERTY_APP_VERSION, appVersion);
        editor.commit();
    }
    ...
    private void storeUserDetails(Context context) {
        ...
        Log.i(TAG, "Saving regId on app version " + appVersion);
        SharedPreferences.Editor editor = prefs.edit();
        editor.putString(com.example.johan.hangmen.main.Util.EMAIL, editText_email.getText().toString());
        editor.putString(com.example.johan.hangmen.main.Util.USER_NAME, editText_user_name.getText().toString());
        editor.commit();
    }
    ...
    private void sendRegistrationIdToBackend() {
        ...
        RequestQueue mRequestQueue = Volley.newRequestQueue(com.example.johan.hangmen.main.MainActivity.this);
...
// Access the RequestQueue through your singleton class.
    ...
    private class SendGcmToServer extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            String url = com.example.johan.hangmen.main.Util.register_url+"?name="+editText_user_name.getText().toString()+"&email="+editText_email.getText().toString()+"&regId="+regid;
            Log.i("pavan", "url" + url);
        ...
        protected void onPostExecute(String result) {
            ...
            if (result != null) {
                if (result.equals("success")) {
                    ...
                    startActivity(new Intent(MainActivity.this, com.example.johan.hangmen.main.ConnectBtActivity.class));
                    finish();
    ...
    private class smppLogin extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... arg0) {
            ...
            String VerifyUserURL = "http://"+ com.example.johan.hangmen.main.Util.SERVER+":9090/plugins/userService/userservice?type=add&secret="+ com.example.johan.hangmen.main.Util.XMPP_SECREAT_KEY+"&"
                    + "username="
                    +editText_user_name.getText().toString()
                    + "&password="+ com.example.johan.hangmen.main.Util.XMPP_PASSWORD+"&name="
                    + editText_user_name.getText().toString()
                    + "&email="
